...
namespace littleEngine
{
	...
	namespace EngineCore
	{
		...
		bool UpdateApplication(IGameApp& game) 
		{
			...
			//UiContext.TransitionResource(Graphics::g_OverlayBuffer, D3D12_RESOURCE_STATE_RENDER_TARGET, true);
			//UiContext.ClearColor(Graphics::g_OverlayBuffer);
			//UiContext.SetRenderTarget(Graphics::g_OverlayBuffer.GetRTV());
			//UiContext.SetViewportAndScissor(0, 0, Graphics::g_OverlayBuffer.GetWidth(), Graphics::g_OverlayBuffer.GetHeight());
		...
		//	TextContext& text = TextContext::Begin();
