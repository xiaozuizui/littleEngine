...
ID3D12CommandAllocator* CommandAllocatorPool::RequestAllocator(uint64_t CompletedFenceValue)
{
	...
	//littleEngine::Utility::Printf("CommandAllocater %d\n", m_ReadyAllocators.size());
	//littleEngine::Utility::Printf("commandAllocator pool %d\n\n",m_AllocatorPool.size());
...
//discard 必须释放由RequestAllocator 申请的
